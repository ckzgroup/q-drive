...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
    ...
    return (
        <div className="bg-primary-foreground drop-shadow-sm py-4 px-2 md:px-8  w-full flex justify-between items-center border-b">
