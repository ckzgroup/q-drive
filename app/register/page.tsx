...
import {UserRegisterForm} from "@/components/lib/forms/user-register-form";

export const metadata: Metadata = {
    title: "Qudrive - Register",
    description: "Create an account to access Qudrive Fleet Management System",
}
                    ...
                    <div className="lg:p-8 ">
                        <div className="relative mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                            ...
                            <div className="flex flex-col space-y-2  z-10">
                                <div className='relative flex space-x-2 mb-12'>
                                    <Image src='/images/logo.svg' alt='logo' height={48} width={48}
                                           style={{objectFit: "cover"}}/>
                                    <h1 className={cn("text-2xl font-bold")}> Qudrive </h1>
                                </div>

                                <h1 className='text-2xl font-light'>Create Company account! </h1>

                                <h3 className="text-xl font-heading font-bold tracking-tight">
                                    Please Register to Continue.
                                </h3>
                                <p className="text-sm text-muted-foreground">
                                    Enter your company information in the form below.
                                </p>
                            </div>

                            {/* USER AUTH FORM */}
                            <UserRegisterForm className='z-10'/>
